                        ...
                        <div class="panel-body foo">
                            <div class="form-group">
                                <div class="text-center">
                                    <a href="insert2.php"><button class="btn btn-primary">เพิ่มอาจารย์คุมแถว</button></a>
                                </div>
                            </div>
                            <table class="table">
                                <thead>
                                    <th>ลำดับแถว</th>
                                    <th>ชื่อ-สกุล อาจารย์คุมแถว</th>
                                    <th>บอร์โทรศัพท์</th>
                                    <th></th>
                                    <th></th>
                                </thead>
                                <tbody>
                                    <?php
                                    $result = $conn->query("SELECT * FROM teacher2 ORDER BY tcid");
                                    ...
                                    ?>
                                        <tr>
                                            ...
                                            <td><?= $row["tcname"] ?></td>
                                            <td><?= $row["tcphone"] ?></td>
                                            <td><a href="editteacher_form2.php?id=<?= $row["tcid"] ?>"><button class="btn btn-warning">แก้ไข</button></a></td>
                                            <td><button class="btn btn-danger" onclick="con(<?= $row["tcid"] ?>)">ลบ</button></td>
                                        </tr>
                                    <?php
                                    endwhile;
                                    ?>
                            ...
                            <!-- <div class="edit">
                                <form action="">
                                    <div class="form-group">
                                        ...
                                        <input type="number" class="form-control" placeholder="ป้อนลำดับแถว">
                                    </div>
                                    <div class="form-group">
                                        <label for="">ชื่อ-สกุล อาจารย์คุมแถว</label>
                                        <input type="text" class="form-control" placeholder="ป้อนชื่อ-สกุล อาจารย์คุมแถว">
                                    </div>
                                    <div class="form-group">
                                        <label for="">เบอร์โทรศัพท์</label>
                                        <input type="text" class="form-control" placeholder="ป้อนเบอร์โทรศัพท์">
                                    </div>
