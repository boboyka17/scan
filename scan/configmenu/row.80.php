						...
						<div class="panel panel-primary">
							...
							<div class="panel-body">
								...
								<form action="" method='get'>
									...
									<input type="submit" name="btn_action" value="submit">
								</form>
								<br>
								<?php
								if (isset($_GET["n"])) {
							...
							<table class="table table-bordered">
								...
								<tr class=""> <?php
												...
												$result = $conn->query($query); ?><?php
																					...
																					if ($numrow < $n)/*maek 80*/ {
																						$tre = "SELECT * FROM scan2557 WHERE level LIKE '%ตรี%' and (education LIKE '%หาร%') and (`chdate31`!='' or 'chdate1'!='' or 'chdate2'!='' ) and status=1 LIMIT " . $chnuml . ";";
