...
<?php $cc=0;  $taw=1;echo "แถว ".$taw." อาจารย์คุมแถว....................................................................................................................";  ?>
					<table class="table table-bordered"   >
						...
						<?php 
						$cout=1;
						$query="SELECT * FROM scan2557 WHERE level LIKE '%ตรี%' and (education LIKE '%ครุ%' or education LIKE '%ศิลปศาส%' or education LIKE '%ศิลปกรรม%' or education LIKE '%รัฐ%' or education LIKE '%พยาบาล%' and  'chdate2'!='')   and `status`='1'
...
<table><tr><?php  $taw=1;echo "แถว ".$taw." อาจารย์คุมแถว....................................................................................................................";  ?></tr></table>
					...
					<table class="table table-bordered"   >
						...
						$query="SELECT * FROM scan2557 WHERE ((level LIKE '%เอก%' and  'chdate2'!='')   and status=1) or ((level LIKE '%โท%' and  'chdate2'!='')   and status=1) order by count ASC;";
						$result=mysql_query($query,$con); ?><?php
						$numrow = mysql_num_rows($result);
						$chnuml=80-$numrow;
						
						if($numrow<80)/*maek 80*/{ $tre="(SELECT * FROM scan2557 WHERE (level LIKE '%ตรี%' and (education LIKE '%หาร%' and 
						 'chdate2'!='')  and status=1 LIMIT ".$chnuml.");";
						...
						$query="SELECT * FROM scan2557 WHERE (level LIKE '%ตรี%' and (education LIKE '%หาร%' or education LIKE '%วิทยา%' or education LIKE '%นิติ%' or education LIKE '%บัญชี%')  and chdate2 !='' ) AND status=1 AND `counteducation` BETWEEN ".$counteducation."  AND 9999;";
