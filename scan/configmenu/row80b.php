					...
					<div class="col-md-9">
						<div class="panel panel-primary">
							...
							<div class="panel-body">
								...
								<table>
								<tr><?php $taw = 1;
									echo "แถว " . $taw . "(บ่าย) อาจารย์คุมแถว....................................................................................................................";  ?></tr>
							</table>
							...
							<table class="table table-bordered">
								...
								<tr class=""> <?php
												...
												$result = $conn->query($query); ?><?php
																					$numrow = $result->num_rows;
																					$chnuml = $n - $numrow;

																					if ($numrow < $n)/*maek 80*/ {
																						$tre = "SELECT * FROM scan2557 WHERE level LIKE '%ตรี%' and ( education LIKE '%ครุ%' or education LIKE '%นิติ%' or education LIKE '%บัญชี%' or education LIKE '%เศรษฐ%' or education LIKE '%ศิลปศาส%' or education LIKE '%พยาบาล%')and (`chdate32`!='' or 'chdate1'!='' or 'chdate2'!='' or `chdate3`!='' or 'chdate12'!='' or 'chdate22'!='' ) and type123!='1'ORDER BY `scan2557`.`count` ASC;;";
																						$resulttree = $conn->query($tre);
																						while ($row11 = $resulttree->fetch_assoc()) {
																							$cc++;
																					?>
								<tr>
									<td><?php echo $cout; ?></td>
									<td><?php echo $row11['counteducation'];
																							$counteducation = $row11['counteducation'] + 1;  ?></td>
									<td><?php echo $row11['pre'] . $row11['name'] . ' ' . $row11['lastname']; ?></td>
									<td><?php
												if ($row11['education'] === 'ครุศาสตรบัณฑิต (หลักสูตร 5 ปี)') {
													echo "ค.บ.";
												} else if ($row11['education'] === 'วิทยาศาสตรบัณฑิต') {
													echo "วท.บ.";
												} else if ($row11['education'] === 'นิติศาสตรบัณฑิต') {
													echo "น.บ.";
												} else if ($row11['education'] === 'รัฐประศาสนศาสตรบัณฑิต') {
													echo "รป.บ.";
												} else if ($row11['education'] === 'ศิลปกรรมศาสตรบัณฑิต') {
													echo "ศป.บ.";
												} else if ($row11['education'] === 'ศิลปศาสตรบัณฑิต') {
													echo "ศศ.บ.";
												} else if ($row11['education'] === 'บัญชีบัณฑิต') {
													echo "บช.บ.";
												} else if ($row11['education'] === 'พยาบาลศาสตรบัณฑิต') {
													echo "พย.บ.";
												} else if ($row11['education'] === 'บริหารธุรกิจบัณฑิต') {
													echo "บธ.บ.";
												} else if ($row11['education'] === 'นิเทศศาสตรบัณฑิต') {
													echo "นศ.บ.";
												} else if ($row11['education'] === 'รัฐศาสตรบัณฑิต') {
													echo "ร.บ.";
												} else if ($row11['education'] === 'ครุศาสตรบัณฑิต') {
													echo "ค.บ.";
												} else if ($row11['education'] === 'เศรษฐศาสตรบัณฑิต') {
													echo "ศ.บ.";
												}
												?></td>
									<td><?php if ($row11['degree'] === '1') {
																								echo "1";
																							} else if ($row11['degree'] === '2') {
																								echo "2";
																							} else {
																							} ?></td>
									<td><?php echo $cout; ?></td>
									...
									<td><?php if ($row11['statustext'] = 'NORMAL') {
																								echo "";
																							} else echo $row11['statustext'] ?></td>
							...
							<?php
																								...
																								echo "แถว " . $taw ."/".$tall. " อาจารย์คุมแถว....................................................................................................................";
						...
						<tr <?php //echo "<P CLASS='breakhere'>"; 
							...
							<?php
																							echo "<p class='breakhere'>";
																							echo "แถว " . $taw ."/".$tall. "(บ่าย2) อาจารย์คุมแถว....................................................................................................................";
						...
						$query = "SELECT * FROM scan2557 WHERE level LIKE '%ตรี%' and (education LIKE '%ครุ%' or education LIKE '%นิติ%' or education LIKE '%บัญชี%' or education LIKE '%เศรษฐ%' or education LIKE '%ศิลปศาส%' or education LIKE '%พยาบาล%')  and (`chdate31`!='' or 'chdate1'!='' or 'chdate2'!='' ) AND status=1 AND `counteducation` BETWEEN " . $counteducation . "  AND 9999;";
