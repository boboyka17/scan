                  ...
                  <div class="panel-heading noPrint">
					...
					<center><h3><span class="label label-info"><?php 
																	...
																	if(@$_POST['come']===$_GET['date']."!='';"){
																		echo "สรุปรายชื่อผู้เข้าร่วมซ้อม บัณฑิตวิทยาลัย";  
																	
																	}else {echo "สรุปรายชื่อผู้ไม่เข้าร่วมซ้อม บัณฑิตวิทยาลัย";  }
					...
					?>
								...
								<select class="form-control noPrint" name="selectpak">
									...
									<option value="select * from scan2557 where faculty = 'บัณฑิตวิทยาลัย' and type123='1' and " selected>ภาคปกติ </option>
