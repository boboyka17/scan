...
?></center>				
					...
					<table class="table table-bordered"   >
						...
						$query="SELECT * FROM scan2557 WHERE level LIKE '%เอก%' or level LIKE '%โท%'and (`chdate31`!='')  and (statustext IS NULL OR statustext not like '%P%') order by count ASC;";
						...
						while($row1=mysql_fetch_assoc($result)==20)   {   $cc++;
							
							
							?>
							
								<tr>
								<td><?php if(80==40){if($cout<=40){echo "A";}else if($cout>40){echo "B"; }} echo $cout; ?></td>
