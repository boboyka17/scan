                        ...
                        <div class="panel-body foo">
                            <div class="form-group">
                                <div class="text-center">
                                    <a href="insert.php"><button class="btn btn-primary">เพิ่มอาจารย์คุมแถว</button></a>
                                </div>
                            </div>
                            <table class="table">
                                <thead>
                                ...
                                <tbody>
                                    <?php
                                    $result = $conn->query("SELECT * FROM teacher ORDER BY tcid");
                                    ...
                                    ?>
                                        <tr>
                                            ...
                                            <td><?= $row["tcname"] ?></td>
                                            <td><?= $row["tcphone"] ?></td>
                                            <td><a href="editteacher_form.php?id=<?= $row["tcid"] ?>"><button class="btn btn-warning">แก้ไข</button></a></td>
