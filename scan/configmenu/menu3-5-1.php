                  ...
                  <div class="panel-heading noPrint">
					...
					<center><h3><span class="label label-info"><?php 
																	...
																	if(@$_POST['come']===$_GET['date']."!='';"){
																		echo "สรุปรายชื่อผู้เข้าร่วมซ้อม คณะวิทยาลัยนานาชาติ";  
																	
																	}else {echo "สรุปรายชื่อผู้ไม่เข้าร่วมซ้อม คณะวิทยาลัยนานาชาติ";  }
					...
					?>
								...
								<select class="form-control noPrint" name="selectpak">
									...
									<option value="select * from scan2557 where faculty = 'วิทยาลัยนานาชาติการท่องเที่ยว' and type123='1' and " selected>ภาคปกติ </option>
						...
						?>
							<tr class="">
								...
								<td><?php   $setlevel=$row1['education'];
															if($setlevel==="บริหารธุรกิจบัณฑิต"){
																echo"บธ.บ.";
