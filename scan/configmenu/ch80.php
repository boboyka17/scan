...
?></center>				
					...
					<table class="table table-bordered"   >
						...
						$query="SELECT * FROM scan2557 WHERE level LIKE '%เอก%' and (`chdate31`!='')  and (statustext IS NULL OR statustext not like '%P%') order by count ASC;";
			...
			<?php
						$query="SELECT * FROM scan2557 WHERE level LIKE '%โท%' and (`chdate31`!='')  and (statustext IS NULL OR statustext not like '%P%') order by count ASC;";
			...
			<?php
						$query="SELECT * FROM scan2557 WHERE level LIKE '%ตรี%' and (`chdate31`!='')  and (statustext IS NULL OR statustext not like '%P%') order by count ASC;";
						...
						while($row1=mysql_fetch_assoc($result) )    {   $cc++;
							...
							{echo "บธ.บ."; } ?>
								...
								<?php $cout++;if($cout>80)  {
									...
									echo "<p class='breakhere'>";
									?>   
									<table class="table table-bordered breakhere">
