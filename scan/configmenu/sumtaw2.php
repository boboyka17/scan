					...
					<div class="col-md-9">
						<div class="panel panel-primary">
							...
							<div class="panel-body">
								...
								<?php $cc = 0;
								$taw = 1;
								$min = $conn->query("SELECT min(count) as m FROM scan2557 WHERE level LIKE '%ตรี%' and ( education LIKE '%ครุ%' or education LIKE '%นิติ%' or education LIKE '%บัญชี%' or education LIKE '%เศรษฐ%' or education LIKE '%ศิลปศาส%' or education LIKE '%พยาบาล%')and (`chdate32`!='' or 'chdate1'!='' or 'chdate2'!='' or `chdate3`!='' or 'chdate12'!='' or 'chdate22'!='' ) and type123!='1'ORDER BY `scan2557`.`count` ASC;");
								$minn=$min->fetch_assoc();
