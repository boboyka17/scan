			  ...
			  <div class="panel	panel-primary">
				  <div class="panel-heading	noPrint">
					 <h3 class="panel-title">
						  <center>&nbsp; <span class="glyphicon	glyphicon-user"></span>&nbsp;ระบบรายงานผลบัณฑิตตามวุฒิ</center>
					 </h3>
				  </div>

					<div class="panel-body">
					<center><h3><span class="label label-warning">ระบบรายงานผลบัณฑิตตามวุฒิ</span></h3></center>
					<br/>
						...
						<table class="table	table-bordered">
							...
							<?php
								if($_GET['day']==1){
									...
									$faculty[1]="ครุศาสตรดุษฎีบัณฑิต";
									$faculty[2]="ครุศาสตรมหาบัณฑิต";
									$faculty[3]="บริหารธุรกิจมหาบัณฑิต";
									$faculty[4]="รัฐประศาสนศาสตรมหาบัณฑิต";
									$faculty[5]="ศิลปศาสตรมหาบัณฑิต";
									$faculty[6]="สาธารณสุขศาสตรมหาบัณฑิต";
									$faculty[7]="ครุศาสตรบัณฑิต";
									$faculty[8]="วิทยาศาสตรบัณฑิต";
									$faculty[9]="นิติศาสตรบัณฑิต";
									$faculty[10]="รัฐประศาสนศาสตรบัณฑิต";
									$faculty[11]="ศิลปกรรมศาสตรบัณฑิต";
									$faculty[12]="ศิลปศาสตรบัณฑิต";
									$faculty[13]="พยาบาลศาสตรบัณฑิต";
									$faculty[14]="บริหารธุรกิจบัณฑิต";
									$faculty[15]="บัญชีบัณฑิต";
								...
								for($num = 1;$num <=15 ;$num++){
									...
									$query1= mysql_query("select *	from scan2557 where	education like '%".$faculty[$num]."%' and status ='1'	and	".$date."!='';",$con);
									$total1= mysql_num_rows($query1);
									

									$query2	= mysql_query("select *	from scan2557 where	education	like'%".$faculty[$num]."%' and status ='2'	and	".$date."!='';",$con);
									$total2	= mysql_num_rows($query2);

									$query3	= mysql_query("select *	from scan2557 where	education like'%".$faculty[$num]."%'	and	status ='3'	and	".$date."!='';",$con);
									$total3	= mysql_num_rows($query3);

									$query4	= mysql_query("select *	from scan2557 where	education like'%".$faculty[$num]."%'	and	".$date."='';",$con);
									$total4	= mysql_num_rows($query4);

									
									$query5	= mysql_query("select *	from scan2557 where	education like'%".$faculty[$num]."%'	and	".$date."!='';",$con);
									$total5	= mysql_num_rows($query5);

									$query6	= mysql_query("select *	from scan2557 where	education like'%".$faculty[$num]."%';",$con);
