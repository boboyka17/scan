                                    ...
                                    ?>
                                        <tr>
                                            ...
                                            <td><?php echo $row1['counteducation'];
                                                $in = floatval($row1["counteducation"]);
                                                if ($ccc == 0) {
                                                    //echo $in;
                                                    $mincount = $in;
                                                    $maxcount = $in;
                                                ...
                                                if ($ccc == 1) {
                                                    if ($mincount > $in && $ccc == 1) {
                                                        $mincount = $in;
                                                        //echo "/min" . $mincount;
                                                    } else if ($maxcount < $in && $ccc == 1) {
                                                        $maxcount = $in;
                                                        //echo "/min" . $mincount;
                                                        //echo "/max" . $maxcount;
                                                    }
                                                ...
                                                //echo "/min" . $mincount;
                                                //echo "/max" . $maxcount;
                                                if ($maxcount == $in && $cout == $n) {
                                                    //echo "maxxxx" . $maxcount;
                                                    $ins     = sprintf("INSERT INTO `taw`(`tawid`, `str`, `stp`) VALUES ('%d','%d','%d')", $tawchk, $mincount, $maxcount);
                                                ...
                                                //echo "/" . $numrow;
                                                //echo "taw" . $tall . "taw" . $taw . "tawchk" . $tawchkl;
                                                if ($taw == $tall && $cc == $numrow) {
                                                    //echo "maxxxx" . $maxcount;
                                                    $ins     = sprintf("INSERT INTO `taw`(`tawid`, `str`, `stp`) VALUES ('%d','%d','%d')", $tawchk, $mincount, $maxcount);
                                                    $insert = $conn->query($ins);
                                                    $tawchk = 0;
