					...
					<div class="col-md-9">
						<div class="panel panel-primary">
							...
							<div class="panel-body">
								...
								<?php $cc = 0;
								$taw = 1;
								$query =  "SELECT * FROM scan2557 WHERE (`chdate32`!='' or `chdate1`!='' or `chdate2`!='' or `chdate3`!='' or `chdate12`!='' or `chdate22`!='' ) and type123!='1'ORDER BY `scan2557`.`count` ASC;";
