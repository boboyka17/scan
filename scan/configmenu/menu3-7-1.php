        ...
        <div class="row">      
              <div class="col-md-12 noPrint">
                   <ul class="breadcrumb">
						...
						<li>
                        <a href="menu_3-0.php">รายงานสรุปตามคณะ</a>ห
                        </li>
                  </ul>
              </div>
        </div>
                  ...
                  <div class="panel-heading noPrint">
					...
					<center><h3><span class="label label-info"><?php 
																	...
																	if(@$_POST['come']===$_GET['date']."!='';"){
																		echo "สรุปรายชื่อผู้เข้าร่วมซ้อม คณะพยาบาลศาสตร์";  
																	
																	}else {echo "สรุปรายชื่อผู้ไม่เข้าร่วมซ้อม คณะพยาบาลศาสตร์";  }
					...
					?>
								...
								<select class="form-control noPrint" name="selectpak">
									...
									<option value="select * from scan2557 where faculty = 'พยาบาลศาสตร์' and type123='1' and " selected>ภาคปกติ </option>
