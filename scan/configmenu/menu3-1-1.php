                  ...
                  <div class="panel-heading noPrint">
					...
					<center><h3><span class="label label-info"><?php 
																	...
																	if(@$_POST['come']===$_GET['date']."!='';"){
																		echo "สรุปรายชื่อผู้เข้าร่วมซ้อม คณะ ครุศาสตร์";  
																	
																	}else {echo "สรุปรายชื่อผู้ไม่เข้าร่วมซ้อม คณะ ครุศาสตร์";  }
					...
					?>
								...
								<select class="form-control noPrint" name="selectpak">
									...
									<option value="select * from scan2557 where faculty = 'ครุศาสตร์' and type123='1' and " selected>ภาคปกติ </option>
						...
						?>
							<tr class="">
								...
								<td><?php   $setlevel=$row1['education'];
															if($setlevel==="ครุศาสตรบัณฑิต (หลักสูตร 5 ปี)"){
																echo"ค.บ. 5 ปี";
