        ...
        <div class="row">
            <div class="panel panel-primary">
                ...
                <div class="panel-body">
                    ...
                    <p align="right">
                        <input name="print" class="noPrint btn btn-success btn-md" type="button" value="Print"
                               onClick="window.print()">
                        <input name="printt" class="noPrint btn btn-success btn-md" type="button" value="Excel"
                               onClick="printt()">
                        <a href="homereport.php"> <input name="printt" class="noPrint btn btn-success btn-md"
                                                         type="button"
                                                         value="กลับ"></a>
                    </p>
                    ...
                    <table class="table table-bordered table2excel">
                        ...
                        <tr class="warning">
                            ...
                            <td>
                                <div align="center">
                                    <?php if ($row['degree'] == '9') echo '-'; else echo $row['degree'] ?>
                                </div>
                            </td>
                            <td>
                                <div align="center">
