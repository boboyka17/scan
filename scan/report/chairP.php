          ...
          <table class="table table-bordered table2excel">
            ...
            <thead>
              ...
              if ($_GET['st'] == 1) {
                ...
                $query1 = "select * from scan2557 where ( education like '%ครุศาสตรบัณฑิต%' or education like '%นิติศาสตรบัณฑิต%' or education like '%รัฐประศาสนศาสตรบัณฑิต%' or education like '%รัฐศาสตรบัณฑิต%' or education like '%ศิลปกรรมศาสตรบัณฑิต%' or education like '%ศิลปศาสตรบัณฑิต%' or education like '%พยาบาลศาสตรบัณฑิต%' )  and status=2 and `statustext` like  '%p%' and ch" . $_POST['date'] . " !='';";
                $query2 = "select * from scan2557 where ( education like '%ครุศาสตรบัณฑิต%' or education like '%นิติศาสตรบัณฑิต%' or education like '%รัฐประศาสนศาสตรบัณฑิต%' or education like '%รัฐศาสตรบัณฑิต%' or education like '%ศิลปกรรมศาสตรบัณฑิต%' or education like '%ศิลปศาสตรบัณฑิต%' or education like '%พยาบาลศาสตรบัณฑิต%' )  and status=3 and `statustext` like  '%p%' and ch" . $_POST['date'] . " !='';";
              } else {
                //$query1="select * from scan2557 where status=2 and `statustext` like  '%p%'  and ch".$_POST['date']." !='';";
                //$query2="select * from scan2557 where status=3 and `statustext` like  '%p%'  and ch".$_POST['date']." !='';";
                $query1 = "select * from scan2557 where (education like '%ดุษฎีบัณฑิต%' or education like '%มหาบัณฑิต%' or education like '%บริหารธุรกิจบัณฑิต%' or education like '%บัญชีบัณฑิต%' or education like '%เศรษฐศาสตรบัณฑิต%' or education like '%วิทยาศาสตรบัณฑิต%' or education like '%นิเทศศาสตรบัณฑิต%' )  and  status=2 and `statustext` like  '%p%'  and ch" . $_POST['date'] . " !='';";
                $query2 = "select * from scan2557 where (education like '%ดุษฎีบัณฑิต%' or education like '%มหาบัณฑิต%' or education like '%บริหารธุรกิจบัณฑิต%' or education like '%บัญชีบัณฑิต%' or education like '%เศรษฐศาสตรบัณฑิต%' or education like '%วิทยาศาสตรบัณฑิต%' or education like '%นิเทศศาสตรบัณฑิต%' )  and  status=3 and `statustext` like  '%p%'  and ch" . $_POST['date'] . " !='';";
              }
