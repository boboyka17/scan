					...
					<div class="panel-body">
						<div class="alert alert-warning" role="alert">
							...
							<form class="form-horizontal" action="sphp/savedate.php">
								<div>
									<h3><b><?php echo "รหัสบัณฑิต : " . $row['counteducation']; ?></b></h3>
									<center><img src="stdimg/login.png" width="80" height="80"></center>
								</div>
								<div class="panel panel-default">
									...
									<div class="panel-heading">
										...
										<input id="dised" type="radio" id="check" name="status" value="3" <?php if ($row['status'] == 3) {
																												echo "checked";
																											}; ?> <?php if (!isset($_SESSION['suser']) or $showstatus['status'] == 3) {
																														echo "disabled";
										...
										<input type="radio" name="savejob" value="2" <?php if ($row['savejob'] == 2) {
																							echo "checked";
																									...
																									echo "disabled";
																								} ?>> ขาดการบันทึก(การมีงานทำ) &nbsp

										<input type="radio" name="savejob" value="1" <?php echo "checked";
																						if ($row['savejob'] == 1) {
																							echo "checked";
																						}; ?> <?php if (!isset($_SESSION['suser']) or $showstatus['status'] == 3) {
																									echo "disabled";
										...
										<!-- <div id="select" class="hide">
											...
											<select id="level" name="type123" id="">
												...
												<option value="1" <?php if ($row["type123"] == 1) echo "selected" ?>>ระดับปกติ</option>
												<option value="2" <?php if ($row["type123"] == 2) echo "selected" ?>>ระดับหนึ่ง</option>
												<option value="3" <?php if ($row["type123"] == 3) echo "selected" ?>>ระดับสอง</option>
												<option value="4" <?php if ($row["type123"] == 4) echo "selected" ?>>ระดับสาม</option>
											</select>
										</div>
										<script>
											$(document).ready(function() {
												var stat = $('#dised').is(':checked');
												if (stat) {
										...
										หมายเหตุพิเศษ<input type="text" name="statustext" size="55" value="<?php echo $row['statustext']; ?>" <?php if (!isset($_SESSION['suser']) or $showstatus['status'] == 3) {
																																					echo "disabled";
																																				} ?>>
									</div>
						...
						?>
							<tbody>
								...
								<tr>
									<td>
										<h4 style="color:#04B431;">
											<font style="color:#2E2E2E;">ชื่อ-สกุล:</font> <?php echo $row['pre'] . " " . $row['name'] . " " . $row['lastname']; ?>
										</h4>
									</td>
